...
import { type ActivePage, type Project } from '../lib/data.tsx';
...
const StartPage = ({ projects, handleButtonClick }: Props) => {
  ...
  return (
    <div className='flex flex-col grow items-center justify-center'>
      ...
      <Button handleClick={() => handleButtonClick('addProject')} text='Create New Project' color='text-gray-200' bgColor='bg-gray-800' />
    </div>
  );
};
